...
export const PERMISSION_META: PermissionMeta[] = [
  ...
  { key: 'manageDevices', label: 'Manage devices', description: 'Create, edit, and delete decrypt-pool devices. It does not change automation configuration or SSH connection settings.', group: 'Automation & Devices' },
