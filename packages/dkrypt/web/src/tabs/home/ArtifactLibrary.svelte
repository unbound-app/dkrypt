    ...
    {:else}
      <div class="divide-border max-h-[34rem] divide-y overflow-y-auto pr-4">
        {#each artifacts as artifact (artifact.id)}
          <div class="grid gap-3 py-3 first:pt-0 last:pb-0 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center xl:grid-cols-[minmax(20rem,1fr)_36rem_auto]">
            ...
            <div class="grid grid-cols-2 gap-x-5 gap-y-2 text-xs sm:col-span-2 sm:grid-cols-4 xl:col-span-1 xl:w-[36rem]">
