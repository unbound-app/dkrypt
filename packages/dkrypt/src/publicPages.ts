  ...
  '/pricing': `
    <main>
      <h1>dkrypt pricing</h1>
        <p>Stripe renews card or bank payments automatically. Crypto access is purchased for 30 days through a NOWPayments invoice and renewed with another crypto payment.</p>
      <section>
  ...
  '/terms': `
    <main>
      <article>
        ...
        <p>Stripe plans renew every 30 days until canceled and show applicable card or bank taxes in Stripe checkout. Crypto access is granted for 30 days after a verified NOWPayments invoice and requires another payment to renew. Stripe Managed Payments handles eligible card or bank purchases as merchant of record. Crypto purchases are outside Stripe Managed Payments, do not use Stripe, and do not require a billing address in the configured checkout. NOWPayments sends funds to the merchant payout wallet, while dkrypt does not store full card details, crypto custody, or wallet private keys.</p>
        <h2>Cancellation and refunds</h2>
        <p>Stripe subscriptions can be canceled through the billing portal and normally end at the current period. Crypto renewal is stopped immediately from dkrypt. Refunds follow the provider-specific refund process, the <a href="/refund-policy">Refund Policy</a>, and mandatory consumer law.</p>
  ...
  '/privacy': `
    <main>
      <article>
        ...
        <p>Data is shared only as needed with GitHub or Discord for authentication, Stripe for card or bank payment and subscription administration, NOWPayments for crypto invoices and payment status, infrastructure providers, Apple services needed to fulfill authorized requests, and authorities where required by law. Personal data is not sold or used for third-party behavioral advertising.</p>
  ...
  '/refund-policy': `
    <main>
      <article>
        ...
        <p>For Stripe purchases, open the dkrypt billing portal or contact ${contactAddress}. For crypto purchases, include the purchase email, NOWPayments invoice or payment identifier, wallet address, and enough transaction information to locate the payment. Do not send full card details or private keys.</p>
        <h2>Technical problems and cancellations</h2>
        <p>For persistent technical defects, contact ${contactAddress}. Stripe subscriptions can be canceled through the billing portal or receipt link. Crypto renewal can be stopped from dkrypt immediately. Cancellation does not automatically refund a completed payment.</p>
        <h2>Processing</h2>
