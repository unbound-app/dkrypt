  ...
  '/terms': `
    <main>
      <article>
        ...
        <p>Stripe plans renew every 30 days until canceled. Crypto access is granted for 30 days after a verified NOWPayments invoice and requires another payment to renew. The plan, price, and applicable tax are presented before purchase. Stripe Managed Payments handles eligible card or bank purchases as merchant of record. Crypto purchases are outside Stripe Managed Payments; dkrypt uses Stripe Tax for the calculation and external tax transaction when configured. NOWPayments sends funds to the merchant payout wallet, while dkrypt does not store full card details, crypto custody, or wallet private keys.</p>
  ...
  '/privacy': `
    <main>
      <article>
        ...
        <p>Data is shared only as needed with GitHub or Discord for authentication, Stripe for payment, tax, and subscription administration, NOWPayments for crypto invoices and payment status, infrastructure providers, Apple services needed to fulfill authorized requests, and authorities where required by law. Personal data is not sold or used for third-party behavioral advertising.</p>
